...
<figure>
    <img src="../img/chain/chain-animation.gif" style="width:40%">
...
<figure>
    <img src="../img/chain/chain-diagram.webp" style="width:70%">
...
!!! Example "Example of Chain Tensioning"
    <figure>
        <img src="../img/chain/turnbuckle.webp" style="width:60%">
