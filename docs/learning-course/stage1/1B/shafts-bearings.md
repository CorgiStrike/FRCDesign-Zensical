...
<figure>
    <img src="../img/examples/bearing-and-shaft.webp" style="width:75%">
...
!!! Example "Example of a Shaft Spinning in a Bearing"
    <figure>
        <img src="../img/examples/shaft-spinning.gif" style="width:100%">
...
<figure>
    <img src="../img/examples/bushing.webp" style="width:50%">
